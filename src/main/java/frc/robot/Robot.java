...
//	PWMVictorSPX _rightRear;    // Drivetrain
    ...
    SpeedControllerGroup speedControllerGroupLeft;
	...
	public Robot() {
        /* Init Hardware */
		//_leftFront = new PWMVictorSPX(0);
		//_rightFront = new PWMVictorSPX(1);
		//_leftRear = new PWMVictorSPX(2);
		//_rightRear = new PWMVictorSPX(3);
